...
def get_explanation(
    ...
    try:
        ...
        raise HTTPException(status_code=400, detail=f"Invalid date format: {dt}") from e
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error computing explanation: {e}") from e
